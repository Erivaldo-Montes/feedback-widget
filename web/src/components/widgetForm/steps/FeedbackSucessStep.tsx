...
interface FeedbackSucesseStepProps{
    onFeedbackRestartRequested:()=>void
}

// tela de sucesso
export function FeedbackSucesseStep({onFeedbackRestartRequested} : FeedbackSucesseStepProps){
    return (
        <>
            <header>
                <CloseButton/>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                {/* botão para outro feedback */}
                <button
                    onClick={onFeedbackRestartRequested}
                    className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent leading-6 hover:bg-zinc-700 transsitio-colors  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500">
                    enviar outro
                </button>
            </div>
